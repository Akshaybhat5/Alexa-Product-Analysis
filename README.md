...
I've used Tokenization and Countvectorizer to clean the text and to convert the textinto a bunch of numbers. These texture converted numbers are fed to the model to predict the outcome. Logistic Regression, Naive Bayes, and RandomForest Classifier are the algorithms used.
